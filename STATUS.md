...
> Quyền tabCapture: mở popup tự chuẩn bị phiên capture ở gain 100% trong ngữ cảnh Chrome action; nút Play nổi tái sử dụng phiên này và đổi gain về 8%, tránh lỗi `Extension has not been invoked for the current page` mà không pause/làm nhỏ âm thanh khi chỉ mở popup.
> Cân bằng âm thanh: TTS được đặt volume tối đa 100%; âm thanh video gốc giảm còn 8% khi dubbing để giọng Hoài My nổi rõ hơn mà không khuếch đại gây clipping.
